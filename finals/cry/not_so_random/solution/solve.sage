...
br = BabyRandom(seed)
calc_s1 = br.next(); print(f'state 1: {calc_s1}')
calc_s2 = br.next(); print(f'state 2: {calc_s2}')
calc_s3 = br.next(); print(f'state 3: {calc_s3}')
calc_s4 = br.next(); print(f'state 4: {calc_s4}')
